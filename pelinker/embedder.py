...
def embed_kb_corpus(
    ...
    Args:
        ...
        batch_size: Embedding batch size inside a chunk
        nlp_model: spaCy model to use for tokenization/lemmas
        head: Number of chunks to process (None for all chunks)
    """
    if use_gpu:
