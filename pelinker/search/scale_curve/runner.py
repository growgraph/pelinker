...
production path exactly — :func:`~pelinker.search.sampling.draw_selection_sample`,
:func:`~pelinker.search.selection.evaluate_selection_sample`,
:func:`~pelinker.search.grid_solver.pooled_min_cluster_size_from_metrics_dfs` — so the measured
...
from pelinker.search.grid_solver import pooled_min_cluster_size_from_metrics_dfs
from pelinker.core.config import ClusteringOptimizationConfig, TransformConfig
...
from pelinker.reports.paths import CLUSTERING_SEARCH_GRID_PER_SAMPLE_CSV_BASENAME
...
SCALE_CURVE_SCHEMA = "pelinker.search.scale_curve.v1"
