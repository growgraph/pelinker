"""Structured checkpoint I/O for ``pelinker.search.dim_selection`` runs.

Shared machinery (version, fingerprint, atomic gzip-aware I/O, the fingerprint fields
common to every search) lives in :mod:`pelinker.search.checkpoint_base`; only the cell-keyed
schema is here.
"""
...
from pelinker.search.checkpoint_base import (
    CHECKPOINT_VERSION,
