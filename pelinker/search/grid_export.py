...
from pelinker.reports.io import _json_normalize
...
def grid_export_rows_from_report(
    ...
    *,
    ...
    hyperparameter is only meaningful against (see :mod:`pelinker.core.scaling`).
    """
...
def _solver_config_snapshot(
    ...
    return {
        ...
        "grid_one_se_k": config.grid_one_se_k,
        "grid_one_se_contiguous": config.grid_one_se_contiguous,
        "grid_one_se_min_samples": config.grid_one_se_min_samples,
    }
...
def _solved_combo_to_jsonable(
    ...
    return {
        ...
        "argmax_min_cluster_size": solved.argmax_min_cluster_size,
        ...
        "one_se_k": solved.one_se_k,
        "n_samples": solved.n_samples,
        "n_clipped": solved.n_clipped,
        ...
        "grid_curve": {
            ...
            "y_se": list(solved.y_se),
            "y_eligible": list(solved.y_eligible),
        },
    }
