...
from pelinker.clustering.metrics import compute_clustering_fit_metrics
...
def fit_transformer_artifacts_on_manifold(
    ...
    """Fit transformer and return :class:`~pelinker.clustering.transform.TransformArtifacts` with UMAP."""
